...
data_root = '{DATA_DIR}/ACDC' #!TBD (path to ACDC dataset)
img_norm_cfg = dict(
...
test_pipeline = [
    ...
    dict(
        ...
        img_scale=(1920//2, 544),
        flip=False,
        transforms=[
            dict(type='Resize', img_scale=(1920//2, 544), keep_ratio=False),
...
data = dict(
    ...
    eval=dict(
        type='CityscapesHamletDataset',
        gt_shape=(1024, 2048, 3),
        data_root='{DATA_DIR}/cityscapes', #!TBD (path to Cityscapes dataset)
